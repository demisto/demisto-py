...
class DefaultApi(object):
    ...
    def import_report(self, file, **kwargs):  # noqa: E501
        """Import a report  # noqa: E501

        Import a report to the system, ignoring ID or version, used to import new reports.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.import_report(file, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.import_report_with_http_info(file, **kwargs)  # noqa: E501
        else:
            (data) = self.import_report_with_http_info(file, **kwargs)  # noqa: E501
            return data

    def import_report_with_http_info(self, file, **kwargs):  # noqa: E501
        """Import a report  # noqa: E501

        Import a report to the system, ignoring ID or version, used to import new reports.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.import_report_with_http_info(file, async_req=True)
        >>> result = thread.get()
        ...
        if ('file' not in params or
                params['file'] is None):
            raise ValueError("Missing the required parameter `file` when calling `import_report`")  # noqa: E501
