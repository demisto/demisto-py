...
class Question(object):
    ...
    def __init__(self, columns=None, default_rows=None, field_associated=None, id=None, label=None, label_arg=None, options=None, options_arg=None, placeholder=None, read_only=None, required=None, tooltip=None, type=None):  # noqa: E501
    ...
    @property
    def options_arg(self):
        """Gets the options_arg of this Question.  # noqa: E501


        :return: The options_arg of this Question.  # noqa: E501
        :rtype: list[AdvanceArg]
        """
        return self._options_arg

    @options_arg.setter
    def options_arg(self, options_arg):
        """Sets the options_arg of this Question.


        :param options_arg: The options_arg of this Question.  # noqa: E501
        :type: list[AdvanceArg]
        """

        self._options_arg = options_arg
