...
class Audit(object):
    ...
    def __init__(self, action=None, id=None, identifier=None, modified=None, object=None, primary_term=None, sequence_number=None, sort_values=None, type=None, user=None, version=None):  # noqa: E501
