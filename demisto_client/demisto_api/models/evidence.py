...
class Evidence(object):
    ...
    def __init__(self, shard_id=None, dbot_created_by=None, description=None, entry_id=None, fetched=None, has_role=None, id=None, incident_id=None, marked_by=None, marked_date=None, modified=None, occurred=None, previous_roles=None, primary_term=None, roles=None, sequence_number=None, sort_values=None, tags=None, tags_raw=None, task_id=None, version=None):  # noqa: E501
