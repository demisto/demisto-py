...
class DemistoApi(object):
    ...
    def get_automation_script(self, id, **kwargs):  # noqa: E501
        """Load Automation  # noqa: E501

        Load Automation by ID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_automation_script(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: the ID of the automation to get (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_automation_script_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_automation_script_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_automation_script_with_http_info(self, id, **kwargs):  # noqa: E501
        """Load Automation  # noqa: E501

        Load Automation by ID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_automation_script_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_automation_script" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_automation_script`")  # noqa: E501
